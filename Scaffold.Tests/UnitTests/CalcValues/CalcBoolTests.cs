...
namespace Scaffold.Tests.UnitTests.CalcValues
{
    public class CalcBoolTests
    {
        ...
        public void AndOperatorTest()
        {
            ...
            Assert.Equal("truth & fake", expectedFalse.TypeName); // note: using Thin Space \u2009
            Assert.True(expectedTrue);
            Assert.Equal("truth & truth", expectedTrue.TypeName); // note: using Thin Space \u2009
            Assert.False(expectedFalse2);
            Assert.Equal("fake & fake", expectedFalse2.TypeName); // note: using Thin Space \u2009
        }
        ...
        public void OrOperatorTest()
        {
            ...
            // Assert
            Assert.True(expectedTrue);
            Assert.Equal("truth ∨ fake", expectedTrue.TypeName); // note: using Thin Space \u2009
            Assert.True(expectedTrue2);
            Assert.Equal("truth ∨ truth", expectedTrue2.TypeName); // note: using Thin Space \u2009
            Assert.False(expectedFalse);
            Assert.Equal("fake ∨ fake", expectedFalse.TypeName); // note: using Thin Space \u2009
        }
        ...
        public void EqualsOperatorTest()
        {
            ...
            Assert.Equal("truth1 = fake1", expectedFalse1.TypeName); // note: using Thin Space \u2009
            Assert.True(expectedTrue);
            Assert.Equal("truth1 = truth2", expectedTrue.TypeName); // note: using Thin Space \u2009
            Assert.True(expectedTrue2);
            Assert.Equal("fake1 = fake2", expectedTrue2.TypeName); // note: using Thin Space \u2009
        }
        ...
        public void NotEqualsOperatorTest()
        {
            ...
            Assert.Equal("truth1 ≠ fake1", expectedTrue1.TypeName); // note: using Thin Space \u2009
            Assert.False(expectedFalse1);
            Assert.Equal("truth1 ≠ truth2", expectedFalse1.TypeName); // note: using Thin Space \u2009
            Assert.False(expectedFalse2);
            Assert.Equal("fake1 ≠ fake2", expectedFalse2.TypeName); // note: using Thin Space \u2009
        }
