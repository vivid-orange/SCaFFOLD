...
{
    public override string TypeName { get;  } = "Create Face Reinforcement Layer By Spacing";
    ...
    protected override CalcFaceReinforcementLayer InitialiseOutput()
    {
        ...
        return new CalcFaceReinforcementLayer(face, Rebar, Spacing, TypeName ?? $"{SectionFace.Value} {Rebar.TypeName} @ {Spacing} c/c");
    }
}
