...
namespace Scaffold.Calculations
{
    public class SteelProfileFixed : CalculationBase, ICalculation
    {
        ...
        public string TypeName => "Different class!!!";
        ...
        [OutputCalcValue]
        public CalcSIQuantity<Area> Area { get; set; } = new CalcSIQuantity<Area>("Area", "A", new Area(0, UnitsNet.Units.AreaUnit.SquareMillimeter));
        [OutputCalcValue]
